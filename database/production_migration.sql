...
CREATE INDEX IF NOT EXISTS idx_user_gitlab_tokens_user_id
  ON user_gitlab_tokens(user_id);
...
CREATE INDEX IF NOT EXISTS idx_gitlab_workspace_config_workspace_id
  ON gitlab_workspace_config(workspace_id);
CREATE INDEX IF NOT EXISTS idx_gitlab_workspace_config_user_id
  ON gitlab_workspace_config(user_id);
...
CREATE INDEX IF NOT EXISTS idx_gitlab_issue_mapping_card_id
  ON gitlab_issue_mapping(card_id);
CREATE INDEX IF NOT EXISTS idx_gitlab_issue_mapping_gitlab_project_id
  ON gitlab_issue_mapping(gitlab_project_id);
